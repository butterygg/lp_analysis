...
## Important
- **Mean** -6.31% and **median** -1.23% IL-only returns are shown below.
...
- Count: **420**
- Mean: **-6.31%**, Std: **15.48%**
- Median: **-1.23%**  |  P25: **-4.73%**  |  P10: **-12.82%**  |  P75: **-0.22%**
...
**Example calculation only**: Let's say Merkl shows **200% APY** (this is just an example - actual APY varies by market) and you experience the **median IL loss (-1.23%)**:

1. **Scale Merkl APY to period**: 200% × 0.036 = 7.1%
2. **Convert to multiplier**: 1 + 7.1% = 1.071
3. **Apply median IL loss**: 1.071 × (1 + -1.2%) = 1.071 × 0.988 = 1.058
4. **Net return for 13 days**: 5.8%
5. **Annualized (APY)**: (1.058)^28.1 - 1 = **387.1% APY**
